...
draw_text(oTextboxScene10_3.x + (boxWidth/2) ,oTextboxScene10_3.y + yBuffer,name); 
draw_set_halign(fa_left);

// Draw part of the text
draw_set_color(c_white); 
draw_text_ext(oTextboxScene10_3.x + xBuffer ,oTextboxScene10_3.y + stringHeight + yBuffer,textPart,stringHeight,boxWidth - (2*xBuffer)); 
