...
draw_text(oTextboxScene6.x + (boxWidth/2) ,oTextboxScene6.y + yBuffer,name); 
draw_set_halign(fa_left);

// Draw part of the text
draw_set_color(c_white); 
draw_text_ext(oTextboxScene6.x + xBuffer ,oTextboxScene6.y + stringHeight + yBuffer,textPart,stringHeight,boxWidth - (2*xBuffer)); 
